...
\documentclass[pdftex,a4paper,fontsize=13pt,version=first,DIV=calc,BCOR5mm,ngerman,twoside,headings=small,titlepage]{scrbook}
% ----- weitere Optionen
...
\renewcommand{\sectionmark}[1]{% adapt the shown section name: show it in lower
% case and with section number
...
%---------------------------------------------------
%\pagenumbering{alph} % even though, these page numbers are not visible there
% are necessary to have unique page numbers
\include{title}
\include{declaration}
